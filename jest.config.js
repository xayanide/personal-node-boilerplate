...
test.ts files are treated as ESM when transform is handled by ts-jest and its useESM prooperty is true
...
but that can trigger a no-shadows warning for ESLint, so that rule is disabled for test files.
*/
...
export default {
    ...
    extensionsToTreatAsEsm: [...jsWithTsEsmPreset.extensionsToTreatAsEsm],
    transform: {
        ...jsWithTsEsmPreset.transform,
    },
...
// cacheDirectory: "C:\\Users\\Ava\\AppData\\Local\\Temp\\jest",
